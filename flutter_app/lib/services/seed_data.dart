...
SeedData buildSeedData() {
  ...
  Company mk(String name, String category, String tagline, String city,
      List<String> coverage, int fleet, int years, bool verified,
  ...
  final companies = <Company>[
    mk('TransGlobal Freight', 'freight',
        ...
        'Chicago, IL', ['National', 'Cross-border'], 120, 14, true, [
      _svc('Full Truckload (FTL)',
          'Dedicated trailer for large shipments, door-to-door.', 'per mile',
          2.4, 'local_shipping'),
      _svc('Less-than-Truckload (LTL)',
          'Share trailer space, pay only for what you ship.', 'per pallet', 65,
          'pallet'),
      _svc('Real-time GPS tracking', 'Live shipment visibility & ETA alerts.',
          'add-on', 19, 'my_location'),
    ]),
    mk('SwiftMove Relocations', 'movers',
        'Stress-free home & office moves with full packing and insurance.',
        'Austin, TX', ['Local', 'Long-distance'], 22, 9, true, [
      _svc('Local home move',
          '2-3 movers, truck, blankets & basic insurance.', 'per hour', 110,
          'home'),
    ...
    mk('RapidParcel Courier', 'courier',
        ...
        'New York, NY', ['Local', 'Same-day'], 60, 6, true, [
      _svc('Same-day delivery', 'Picked up & delivered within 4 hours.', 'flat',
          14, 'bolt'),
      _svc('Express overnight', 'Guaranteed next-morning delivery.', 'flat', 9,
          'schedule'),
    ...
    mk('Horizon Coaches', 'coach',
        ...
        'Denver, CO', ['Regional', 'National'], 18, 20, true, [
      _svc('49-seat luxury coach', 'WiFi, restroom, reclining seats.', 'per day',
          950, 'directions_bus'),
      _svc('Minibus (16-seat)', 'Ideal for small groups & airport runs.',
          'per day', 420, 'airport_shuttle'),
      _svc('Event shuttle loop', 'Continuous shuttle for festivals & weddings.',
          'quote', 0, 'sync'),
    ]),
    mk('CityRide Express', 'ride',
        'Reliable on-demand rides, airport transfers and corporate accounts.',
        'Seattle, WA', ['Local'], 80, 5, false, [
      _svc('Standard ride', 'Comfortable sedan, up to 4 passengers.', 'per mile',
          1.8, 'local_taxi'),
    ...
    mk('PolarLine Cold-Chain', 'coldchain',
        ...
        'Miami, FL', ['National', 'Cross-border'], 35, 11, true, [
      _svc('Frozen (-18°C) transport', 'Deep-freeze trailers with data logging.',
          'per mile', 3.1, 'ac_unit'),
      _svc('Pharma (2-8°C) cold-chain', 'GDP-compliant, validated reefer units.',
          'quote', 0, 'medical_services'),
      _svc('Temperature data logging',
          'Continuous monitoring & compliance report.', 'add-on', 29,
          'thermostat'),
    ]),
    mk('TitanHaul Heavy Logistics', 'heavy',
        'Oversized, abnormal and project cargo with permits and escorts.',
        'Houston, TX', ['National'], 14, 17, true, [
      _svc('Lowboy heavy haul', 'Up to 80-ton machinery & equipment.', 'quote',
          0, 'precision_manufacturing'),
      _svc('Permit & route survey',
          'We handle abnormal-load permits & escorts.', 'flat', 650, 'route'),
      _svc('Crane-assisted load/unload', 'On-site lifting for plant relocation.',
          'quote', 0, 'construction'),
    ]),
    mk('VoltWay Green Fleet', 'ev',
        'Carbon-neutral urban delivery with a 100% electric fleet.',
        'San Francisco, CA', ['Local', 'Same-day'], 40, 3, true, [
      _svc('EV same-day delivery', 'Zero-emission vans across the city.', 'flat',
          16, 'electric_bolt'),
      _svc('Carbon-neutral courier', 'Bike + EV last-mile with offset report.',
          'flat', 8, 'eco'),
    ...
    mk('AeroDrop Air & Drone', 'air',
        ...
        'Atlanta, GA', ['National', 'Last-mile'], 25, 4, false, [
      _svc('Air cargo (next-flight-out)', 'Urgent freight on the next departure.',
          'per kg', 4.2, 'send'),
      _svc('Last-mile drone delivery', 'Sub-5kg parcels delivered by drone.',
          'flat', 22, 'send'),
      _svc('Medical / organ courier', 'Priority climate-safe air transport.',
          'quote', 0, 'emergency'),
    ]),
    mk('BlueWave Ferry & Marine', 'ferry',
        'Ro-Ro vehicle ferries and container transfers along the coast.',
        'San Diego, CA', ['Regional', 'Marine'], 8, 22, true, [
      _svc('Vehicle ferry (Ro-Ro)', 'Drive-on, drive-off car & truck ferry.',
          'per vehicle', 120, 'directions_boat'),
      _svc('Container marine transfer', 'Port-to-port container shipping.',
          'quote', 0, 'anchor'),
      _svc('Passenger + cargo combo', 'Mixed crossings for islands & coast.',
          'per trip', 38, 'sailing'),
    ]),
  ];
